...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.change_window = QPushButton(Widget)
        self.change_window.setObjectName(u"change_window")
        sizePolicy.setHeightForWidth(self.change_window.sizePolicy().hasHeightForWidth())
        self.change_window.setSizePolicy(sizePolicy)
        self.change_window.setMinimumSize(QSize(150, 50))
        self.change_window.setCursor(QCursor(Qt.PointingHandCursor))
        self.change_window.setStyleSheet(u"background: qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba(74, 74, 74, 255), stop:1 rgba(64, 64, 64, 255));\n"
"border: 1px solid #6a6a6a;\n"
"color: white;")

        self.verticalLayout_3.addWidget(self.change_window)
...
"color: white;")
        ...
        self.processed_img.viewport().setProperty("cursor", QCursor(Qt.CrossCursor))
...
"border: 1px solid #2d2d2d;")
    ...
    def retranslateUi(self, Widget):
        ...
        self.change_window.setText(QCoreApplication.translate("Widget", u"Mode: Image", None))
